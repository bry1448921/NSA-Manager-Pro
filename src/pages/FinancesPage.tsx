...
import { DollarSignIcon, ReceiptTextIcon, PlusCircleIcon, BellIcon } from "lucide-react";
...
const FinancesPage: React.FC = () => {
  ...
  useEffect(() => {
    if (!remindersShown && upcomingExpenses.length > 0) {
      // Show a single summary toast and up to 3 detailed toasts
      ...
      <div className="w-full max-w-6xl bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md mt-8 space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Income</h2>
